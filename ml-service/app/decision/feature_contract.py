...
# NOTE: Must match trained models (46 total features)
VIDEO_FEATURES: List[str] = [
    "face_presence_ratio",          # 41: Proportion of frames with face detected
    "eye_contact_ratio",            # 42: Proportion with eye contact (facing camera)
    "head_motion_variance",         # 43: Variance in head movement (nervousness indicator)
    "facial_engagement_score",      # 44: Facial activity/engagement level
    "video_available",              # 45: Binary flag indicating video was available
]
...
FEATURE_METADATA: Dict[str, Dict] = {
    ...
    # NOTE: Only 5 video features to match trained models (46 total)
