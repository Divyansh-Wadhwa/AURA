...
class TextMetrics(BaseModel):
    ...
    semantic_relevance_mean: Optional[float] = Field(None, ge=0, le=1)
    semantic_relevance_std: Optional[float] = Field(None, ge=0, le=1)
    topic_drift_ratio: Optional[float] = Field(None, ge=0, le=1)
    avg_sentence_length: Optional[float] = Field(None, ge=1, le=100)
    sentence_length_std: Optional[float] = Field(None, ge=0, le=50)
    avg_response_length_sec: Optional[float] = Field(None, ge=0, le=300)
    response_length_consistency: Optional[float] = Field(None, ge=0, le=1)
    assertive_phrase_ratio: Optional[float] = Field(None, ge=0, le=1)
    modal_verb_ratio: Optional[float] = Field(None, ge=0, le=1)
    hedge_ratio: Optional[float] = Field(None, ge=0, le=1)
    filler_word_ratio: Optional[float] = Field(None, ge=0, le=1)
    empathy_phrase_ratio: Optional[float] = Field(None, ge=0, le=1)
    reflective_response_ratio: Optional[float] = Field(None, ge=0, le=1)
    question_back_ratio: Optional[float] = Field(None, ge=0, le=1)
    avg_sentiment: Optional[float] = Field(None, ge=-1, le=1)
    sentiment_variance: Optional[float] = Field(None, ge=0, le=1)
    negative_spike_count: Optional[int] = Field(None, ge=0, le=50)
